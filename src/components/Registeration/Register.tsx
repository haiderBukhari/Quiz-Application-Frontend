    ...
    return (
        <div className="my-3 mx-2 px-4">
            ...
            <div style={{ display: 'flex', flexDirection: "column", justifyContent: 'center', alignItems: "center", width: "100%" }}>
                ...
                />
                <button disabled={!verified || error.email || error.name || error.confirmpassword || error.password} className={`m-aut0 px-12 py-3 text-white mt-5 bg-sky-600 hover:bg-sky-500 flex justify-center items-center ${verified ? 'cursor-pointer' : 'cursor-not-allowed'}`} style={{ borderRadius: "4px" }}>Sign Up <ArrowForwardIcon style={{ marginLeft: "5px" }} /></button>
            </div>
        </div>
    )
}